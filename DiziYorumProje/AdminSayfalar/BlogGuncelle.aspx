...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form runat="server" class="form-group">
        <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" PlaceHolder="Başlık"></asp:TextBox>
        <br />
        ...
        <br />
         <asp:TextBox ID="TextBox4" runat="server" CssClass="form-control" PlaceHolder="Blog İçreik" TextMode="MultiLine" Height="300px"></asp:TextBox>
        <br />
