<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="Istatistikler.aspx.cs" Inherits="DiziYorumProje.AdminSayfalar.Istatistikler" %>
    ...
    <table class="table table-bordered">
        <tr>
         ...
         <tr>
            ...
            <td>
               En Fazla Yorum Alan Blog: <asp:Label ID="Label6" runat="server" Text="Label"></asp:Label>
            </td>
        </tr>
    </table>
</asp:Content>
