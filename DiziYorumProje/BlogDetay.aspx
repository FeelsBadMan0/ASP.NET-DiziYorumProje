                ...
                <div class="col-md-8 single-main">
                    <div class="single-grid">
                        <asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
                                ...
                                <img src=<%# Eval("BLOGGORSEL") %> alt="" style="height:350px; margin-bottom:20px;"/>
                    ...
                    <div class="content-form">
                        ...
                        <form runat="server">
                            ...
                            <asp:TextBox ID="TextBox3" runat="server" PlaceHolder="Yorumunuz" TextMode="MultiLine" Height="200px"></asp:TextBox>
